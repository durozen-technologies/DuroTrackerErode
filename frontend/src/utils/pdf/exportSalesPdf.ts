...
export async function exportSalesPdf({ dateFrom, dateTo, groupBy, data }: { dateFrom?: string; dateTo?: string; groupBy?: string; data: any }) {
  ...
  `;
  await generateAndSharePdf(html, 'Sales');
}
